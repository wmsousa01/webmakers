...
const ChatGPTChat = () => {
  ...
  const handleNextStep = (value) => {
    if (step === 0) {
      ...
      const trimmedValue = value.trim().toLowerCase(); // Remove espaços e normaliza
  ...
  return (
    <div id="chat" className="flex flex-col items-center p-5 md:p-20 bg-gray-100 min-h-screen w-full">
      {/* Título */}
      ...
      {/* Área do Chat */}
      <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-4 h-[32rem] overflow-y-auto mb-4">
